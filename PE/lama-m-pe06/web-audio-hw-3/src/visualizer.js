...
const setupCanvas = (canvasElement,analyserNodeRef) => {
	...
	gradient = utils.getLinearGradient(ctx,0,0,0,canvasHeight,[{percent:0,color:"rgb(48,207,208)"},{percent:1,color:"rgb(51,8,103)"}]);
...
const draw = (params={}) => {
  ...
  if(params.showCircles) {
    ...
    // red-ish circles
      ...
      ctx.save();
      ctx.beginPath();
      ctx.fillStyle = utils.makeColor(200, 200, 0, 0.5 - percent / 10.0);
